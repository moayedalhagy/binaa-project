...
class LevelOneSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $version = Level::create(['label' => 'One', 'sort_order' => 1])
            ->versions()
            ->create([
                'value' => 60,
                'published' => false
        ...
        $questions = [
            ['label' => 'صلاة الصبح', 'sort_order' => 1],
            ['label' => 'صلاة العصر', 'sort_order' => 2],
            ['label' => 'صلاة العشاء', 'sort_order' => 3],
        ];
        ...
        $questionForFriday = [
            ['label' => 'العام الحالي', 'options' =>  $optionsQOne, 'sort_order' => 1],
